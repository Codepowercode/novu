...
import { APNSHandler, FCMHandler, ExpoHandler, GotifyHandler } from './handlers';

export class PushFactory implements IPushFactory {
  handlers: IPushHandler[] = [new FCMHandler(), new ExpoHandler(), new APNSHandler(), new GotifyHandler()];
